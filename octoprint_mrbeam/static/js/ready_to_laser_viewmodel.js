...
//                };
        ...
        self._fromData = function(payload) {
            ...
            console.log("_fromData() interlocks_closed: "+self.interlocks_closed()+", is_cooling_mode: "+self.is_cooling_mode()+", is_fan_connected: "+self.is_fan_connected() +", is_rtl_mode: "+self.is_rtl_mode());
        }
